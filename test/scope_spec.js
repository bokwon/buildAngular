...
describe('Scope', function() {
	...
	describe('$digest', function() {
		...
		it('test how many times the watchExpressions runs', function() {
	...
	describe('$evalAsync', function() {
		...
		it('executes $evalAsynced functions added by watch function', function() {
			scope.aValue = [1, 2, 3];
			scope.asyncEvaluated = false;
			scope.$watch(
				function(scope) {
		...
		it('executes $evalAsynced functions even when watches are not dirty', function() {
			scope.aValue = [1, 2, 3];
  ...
  describe('$watchCollection', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('does not stop on exceptions on '+method, function() {
        var listener1 = function(event) {
          throw 'listener1 throwing an exeception';
        };
        var listener2 = jasmine.createSpy();
        scope.$on('someEvent', listener1);
        scope.$on('someEvent', listener2);
    ...
    it('propagates down the scope hierachy on $broadcast', function() {
      var scopeListener = jasmine.createSpy();
    ...
    it('sets currentScope to null after propagation on $broadcast', function() {
      ...
      expect(event.currentScope).toBe(null);
		...
		it('it received by listeners on current scope after being stopped', function() {
			var listener1 = function(event) {
				event.stopPropagation();
			};
			var listener2 = jasmine.createSpy();
